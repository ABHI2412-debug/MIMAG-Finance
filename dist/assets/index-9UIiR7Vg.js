(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`modulepreload`,t=function(e){return`/`+e},n={},r=function(r,i,a){let o=Promise.resolve();if(i&&i.length>0){let r=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function u(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}o=l(i.map(i=>{if(i=t(i,a),i=u(i),i in n)return;n[i]=!0;let o=i.endsWith(`.css`);for(let e=r.length-1;e>=0;e--){let t=r[e];if(t.href===i&&(!o||t.rel===`stylesheet`))return}let s=document.createElement(`link`);if(s.rel=o?`stylesheet`:e,o||(s.as=`script`),s.crossOrigin=``,s.href=i,c&&s.setAttribute(`nonce`,c),document.head.appendChild(s),o)return new Promise((e,t)=>{s.addEventListener(`load`,e),s.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${i}`)))})}).filter(e=>e!==void 0))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(e=>{for(let t of e||[])t.status===`rejected`&&s(t.reason);return r().catch(s)})},i=[{icon:`📈`,name:`Mutual Funds`,desc:`Grow your wealth with expert guidance.`,details:`Our Mutual Fund advisory helps you select the best equity, debt, and hybrid funds based on your risk profile and financial goals. We provide regular portfolio rebalancing and performance tracking to ensure you stay on the path to wealth creation.`},{icon:`🛡️`,name:`Term Insurance`,desc:`Financial security for your loved ones.`,details:`Protect your family's financial future with comprehensive term insurance plans. We help you calculate the optimal cover amount and choose policies with high claim settlement ratios at the most competitive premiums.`},{icon:`❤️`,name:`Health Insurance`,desc:`Better health. Brighter tomorrow.`,details:`Medical emergencies shouldn't drain your savings. We guide you through selecting robust health insurance plans that offer extensive coverage, cashless hospitalization, and no hidden sub-limits for complete peace of mind.`},{icon:`💼`,name:`PMS`,desc:`Personalised wealth management.`,details:`For high-net-worth individuals, our Portfolio Management Services offer customized investment strategies. Benefit from direct equity exposure, active fund management by seasoned experts, and exclusive investment opportunities.`},{icon:`📊`,name:`AIF`,desc:`Access alternative investment opportunities.`,details:`Diversify beyond traditional asset classes with Alternative Investment Funds. We provide access to private equity, real estate, hedge funds, and venture capital, designed for sophisticated investors seeking alpha.`},{icon:`💰`,name:`SIP`,desc:`Small steps. Big wealth.`,details:`Systematic Investment Plans (SIPs) are the most disciplined way to build wealth. By investing a fixed amount regularly, you benefit from rupee cost averaging and the incredible power of compounding over time.`},{icon:`🏛️`,name:`NPS`,desc:`Plan for a peaceful retirement.`,details:`The National Pension System (NPS) offers a highly tax-efficient way to build your retirement corpus. We help you choose the right pension fund manager and asset allocation to ensure a steady income in your golden years.`},{icon:`📋`,name:`Fixed Deposits`,desc:`Stable returns. Lower risk.`,details:`Preserve your capital and earn guaranteed returns with corporate and bank Fixed Deposits. We handpick high-rated FDs that offer better interest rates than traditional savings accounts while ensuring maximum safety.`},{icon:`🔗`,name:`Loan Against
Mutual Funds`,desc:`Unlock the value of your investments.`,details:`Need urgent liquidity? Don't sell your mutual funds. We help you secure an overdraft facility against your mutual fund holdings at attractive interest rates, so your investments continue to grow while you meet short-term cash needs.`}],a=[{name:`UTI`,color:`#d4380d`,img:`https://logo.uplead.com/utimf.com`},{name:`HDFC`,color:`#004b87`,img:`https://logo.uplead.com/hdfcbank.com`},{name:`SBI`,color:`#1a237e`,img:`https://logo.uplead.com/sbi.co.in`},{name:`ICICI Prudential`,color:`#f57f17`,img:`https://logo.uplead.com/icicibank.com`},{name:`Kotak`,color:`#e53935`,img:`https://logo.uplead.com/kotak.com`},{name:`LIC`,color:`#1b5e20`,img:`https://logo.uplead.com/licindia.in`},{name:`Axis`,color:`#880e4f`,img:`https://logo.uplead.com/axisbank.com`}],o=[{name:`Rahul Mehta`,role:`Software Engineer`,stars:5,text:`MIMAG helped me plan my investments with clarity. Their guidance on mutual funds and SIPs has truly made a difference in my financial journey.`,img:`./assets/profile_rahul.png`},{name:`Priya Sharma`,role:`Business Owner`,stars:5,text:`The term and health insurance advice is outstanding. I really feel financially secure for my family's future.`,img:`./assets/profile_priya.png`},{name:`Amit Kulkarni`,role:`Entrepreneur`,stars:5,text:`Professional, transparent, and always available. I highly recommend MIMAG for anyone serious about long-term financial planning.`,img:`./assets/profile_amit.png`}],s=[{tag:`Equity`,title:`The Power of SIPs in Building Long-Term Wealth`,date:`Aug 26, 2024`,image:`./assets/insights_blog_1.png`},{tag:`Insurance`,title:`Why Term Insurance is a Must-Have in 2024`,date:`Aug 20, 2024`,image:`./assets/insights_blog_2.png`},{tag:`Funds`,title:`NPS vs Mutual Funds: Which is Right for You?`,date:`Aug 12, 2024`,image:`./assets/finance-building.jpg`}],c=[{name:`MIMAG High-Growth Equity`,category:`Equity - Large & Mid Cap`,risk:`Very High`,return5y:`18.4%`,minSip:`₹ 1,000`,nav:`124.55`,tag:`Top Rated`},{name:`MIMAG Tax Saver 80C`,category:`ELSS - Tax Saving`,risk:`High`,return5y:`15.2%`,minSip:`₹ 500`,nav:`86.12`,tag:`Tax Saver`},{name:`MIMAG Stable Debt Fund`,category:`Debt - Corporate Bond`,risk:`Low to Moderate`,return5y:`7.8%`,minSip:`₹ 1,000`,nav:`32.40`,tag:`Low Risk`}],l=[{q:`What is the minimum amount required to start a SIP?`,a:`You can start a Systematic Investment Plan (SIP) with as little as ₹500 per month for most mutual funds.`},{q:`How do I track my portfolio performance?`,a:`MIMAG Finance provides a unified dashboard where you can track all your mutual funds, insurance, and other assets in real-time.`},{q:`Is my money safe with MIMAG?`,a:`We partner directly with SEBI-registered AMCs and IRDAI-approved insurers. Your investments are held securely with the respective institutions.`},{q:`Can I withdraw my mutual fund investments anytime?`,a:`Yes, open-ended mutual funds can be withdrawn at any time. However, ELSS (Tax Saver) funds have a mandatory 3-year lock-in period.`}],u=[{step:`01`,title:`Discovery`,desc:`We understand your goals, risk appetite, and current financial standing.`},{step:`02`,title:`Strategy`,desc:`Our experts design a custom portfolio tailored to achieve your specific targets.`},{step:`03`,title:`Execution`,desc:`Seamless onboarding and investment execution via our digital platform.`},{step:`04`,title:`Review`,desc:`Continuous monitoring and periodic rebalancing to keep you on track.`}],d=[{name:`NIFTY 50`,val:`22,514.65`,change:`+0.85%`},{name:`SENSEX`,val:`74,228.02`,change:`+0.78%`},{name:`GOLD (10g)`,val:`71,450`,change:`-0.12%`},{name:`USD/INR`,val:`83.45`,change:`-0.05%`},{name:`NIFTY BANK`,val:`48,159.10`,change:`+1.20%`}],f=[{img:`./assets/ls_first_investment.png`,title:`First Investment`,desc:`Start your wealth journey with confidence.`},{img:`./assets/ls_growing_family.png`,title:`Growing Family`,desc:`Secure what matters most.`},{img:`./assets/ls_retirement_planning.png`,title:`Retirement Planning`,desc:`Turn today's planning into tomorrow's freedom.`},{img:`./assets/ls_tax_efficiency.png`,title:`Tax Efficiency`,desc:`Keep more of what you earn.`},{img:`./assets/ls_legacy_planning.png`,title:`Legacy Planning`,desc:`Create a lasting impact for generations.`}],p=e=>`₹ ${Math.round(e).toLocaleString(`en-IN`)}`,m=(e,t,n)=>{let r=n*12,i=t/12/100;return i===0?e*r:e*(((1+i)**r-1)/i)*(1+i)},h=(e,t,n)=>e*(1+t/100)**n;function g(e,t,n,r){if(window.matchMedia(`(prefers-reduced-motion: reduce)`).matches){e.textContent=p(n);return}let i=null,a=o=>{i||=o;let s=Math.min((o-i)/r,1),c=1-(1-s)**3;e.textContent=p(t+(n-t)*c),s<1?window.requestAnimationFrame(a):e.textContent=p(n)};window.requestAnimationFrame(a)}var _=()=>{document.querySelector(`#app`).innerHTML=`
  ...
  <div class="ticker-wrap">
    <div class="ticker">
      ...
      <div class="ticker-item">
        <span>${e.name}</span>
        <strong>${e.val}</strong>
        <em class="${e.change.startsWith(`-`)?`down`:`up`}">${e.change}</em>
      </div>
      `).join(``)}
    </div>
  </div>
  ...
  <section class="sec sec--cream" id="services" style="position:relative; overflow:hidden;">
    ...
    <div class="container" style="position:relative; z-index:1;">
      ...
      <div class="svc-grid">
        ${i.map((e,t)=>`
        <div class="svc-card reveal reveal-delay-${t%5+1}" data-index="${t}" style="cursor:pointer;" onclick="openServiceModal(${t})">
          <span class="svc-ico">${e.icon}</span>
          <h3>${e.name}</h3>
          <p>${e.desc}</p>
  ...
  <section class="lifestage-section" id="lifestages">
    <div class="lifestage-container">
      ...
      <div class="lifestage-carousel" id="ls-carousel">
        ${f.map((e,t)=>`
        <div class="ls-card reveal reveal-delay-${t%5+1}">
  ...
  <section class="sec sec--dark-bg" id="funds" style="background:#111; color:#fff;">
    <div class="container">
      ...
      <div class="funds-grid">
        ${c.map((e,t)=>`
        <div class="fund-card reveal reveal-delay-${t+1}">
          <span class="fund-tag">${e.tag}</span>
          <h3>${e.name}</h3>
          <p class="fund-cat">${e.category} • ${e.risk}</p>
          <div class="fund-stats">
            <div class="f-stat"><span>5Y Return</span><strong class="text-green">${e.return5y}</strong></div>
            <div class="f-stat"><span>Min SIP</span><strong>${e.minSip}</strong></div>
          </div>
  ...
  <section class="sec sec--partners" id="partners">
    <div class="container">
      ...
      <div class="partners-row" style="display: flex; gap: 24px; align-items: center; padding-left: 5%; flex-wrap: wrap;">
        ${a.map(e=>`
          <div class="partner-logo" style="--pc:${e.color}; border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; overflow: hidden; padding: 12px; background: rgba(0,0,0,0.4); display: flex; align-items: center; justify-content: center; width: 140px; height: 70px;">
            <img src="${e.img}" alt="${e.name}" style="max-width: 100%; max-height: 100%; object-fit: contain; filter: grayscale(100%) brightness(150%); opacity: 0.7; transition: all 0.3s;" onmouseover="this.style.filter='grayscale(0) brightness(100%)'; this.style.opacity='1'" onmouseout="this.style.filter='grayscale(100%) brightness(150%)'; this.style.opacity='0.7'">
          </div>
        `).join(``)}
  ...
  <section class="sec sec--cream" id="process">
    <div class="container">
      ...
      <div class="process-grid">
        ${u.map((e,t)=>`
        <div class="process-step reveal reveal-delay-${t+1}">
          <div class="step-num">${e.step}</div>
          <h3>${e.title}</h3>
          <p>${e.desc}</p>
        </div>`).join(``)}
      </div>
  ...
  <section class="sec sec--white" id="faq">
    <div class="container">
      ...
      <div class="faq-list">
        ${l.map((e,t)=>`
        <div class="faq-item reveal reveal-delay-${t%4+1}">
          <button class="faq-btn">${e.q} <i class="faq-icon">+</i></button>
  ...
  <section class="sec sec--cream" id="insights">
    <div class="container">
      ...
      <div class="ins-grid">
        ${s.map((e,t)=>`
        <div class="ins-card reveal reveal-delay-${t%3+1}">
          <div class="ins-img" style="background-image:url('${e.image}')">
            <span class="ins-tag">${e.tag}</span>
          </div>
          <div class="ins-body" style="display:flex; flex-direction:column; min-height: 140px;">
            <h3 style="margin-bottom:24px;">${e.title}</h3>
            <div style="display:flex; justify-content:space-between; align-items:center; margin-top:auto;">
              <span class="ins-date">${e.date}</span>
  ...
  `},v=`sip`;function y(){let e=Math.max(1,Number(document.querySelector(`#cIn1`).value)||0),t=Math.max(1,Number(document.querySelector(`#cIn2`).value)||0),n=Math.max(1,Number(document.querySelector(`#cIn3`).value)||0),r,i;v===`sip`?(r=e*n*12,i=m(e,t,n)):(r=e,i=h(e,t,n));let a=i-r,o=document.querySelector(`#rInv`),s=document.querySelector(`#rRet`),c=document.querySelector(`#rTot`),l=o.dataset.val?parseFloat(o.dataset.val):null;l===null?(o.textContent=p(r),s.textContent=p(a),c.textContent=p(i)):(g(o,l,r,500),g(s,parseFloat(s.dataset.val),a,500),g(c,parseFloat(c.dataset.val),i,500),[o,s,c].forEach(e=>{e.classList.remove(`highlight-flash`),e.offsetWidth,e.classList.add(`highlight-flash`)})),o.dataset.val=r,s.dataset.val=a,c.dataset.val=i}function b(e){v=e,document.querySelectorAll(`.calc-tab`).forEach(t=>t.classList.toggle(`active`,t.dataset.mode===e));let t=document.querySelector(`#calcForm`);t.innerHTML=e===`sip`?`
      ...
      <button class="btn btn--gold btn--block" id="calcBtn" type="button">Calculate Now →</button>`,document.querySelector(`#calcBtn`).addEventListener(`click`,y),document.querySelectorAll(`#calcForm input`).forEach(e=>e.addEventListener(`input`,y)),y()}function x(e){let t=document.querySelector(`#toast`);t.textContent=e,t.classList.add(`show`),setTimeout(()=>t.classList.remove(`show`),3200)}_(),document.querySelector(`#calcBtn`).addEventListener(`click`,y),document.querySelectorAll(`#calcForm input`).forEach(e=>e.addEventListener(`input`,y)),document.querySelectorAll(`.calc-tab`).forEach(e=>e.addEventListener(`click`,()=>b(e.dataset.mode))),y(),requestAnimationFrame(()=>{setTimeout(()=>{let e=document.querySelector(`#globe-scene`);e&&r(async()=>{let{initGlobe:e}=await import(`./globe-viYAnwdT.js`);return{initGlobe:e}},[]).then(({initGlobe:t})=>{e&&t(e)}).catch(e=>console.warn(`Globe:`,e))},120)}),document.querySelector(`#menuBtn`).addEventListener(`click`,()=>{document.querySelector(`#mainNav`).classList.toggle(`open`)}),document.querySelector(`#nlForm`).addEventListener(`submit`,e=>{e.preventDefault(),e.currentTarget.reset(),x(`Thanks! You're subscribed to MIMAG Finance insights.`)});var S=document.getElementById(`contactModal`),C=document.getElementById(`modalClose`),w=document.getElementById(`moneyGuideForm`),T=document.querySelectorAll(`a[href="#contact"], #fabBtn`);S&&(T.forEach(e=>{e.addEventListener(`click`,e=>{e.preventDefault(),S.classList.add(`active`)})}),C.addEventListener(`click`,()=>S.classList.remove(`active`)),S.addEventListener(`click`,e=>{e.target===S&&S.classList.remove(`active`)}),w.addEventListener(`submit`,e=>{e.preventDefault(),S.classList.remove(`active`),x(`Request sent successfully! Our guide will contact you soon.`),w.reset()})),window.openServiceModal=function(e){let t=i[e];t&&(document.getElementById(`smIcon`).textContent=t.icon,document.getElementById(`smTitle`).textContent=t.name,document.getElementById(`smDesc`).textContent=t.desc,document.getElementById(`smDetails`).textContent=t.details,document.getElementById(`serviceModal`).classList.add(`active`))};var E=new IntersectionObserver((e,t)=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`is-visible`),t.unobserve(e.target))})},{root:null,rootMargin:`0px`,threshold:.15});document.querySelectorAll(`.reveal`).forEach(e=>E.observe(e));var D=document.getElementById(`scroll-progress`),O=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;if(!O){let e=!1;window.addEventListener(`scroll`,()=>{e||=(window.requestAnimationFrame(()=>{let t=window.scrollY,n=document.documentElement.scrollHeight-window.innerHeight;D&&(D.style.width=t/n*100+`%`),e=!1}),!0)})}if(document.querySelectorAll(`.faq-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.closest(`.faq-item`),n=document.querySelector(`.faq-item.active`);n&&n!==t&&n.classList.remove(`active`),t.classList.toggle(`active`)})}),!O&&window.matchMedia(`(hover: hover)`).matches){let e=document.getElementById(`mainNav`),t=document.getElementById(`navHighlight`);e.querySelectorAll(`a`).forEach(e=>{e.addEventListener(`mouseenter`,e=>{t.style.opacity=`1`,t.style.width=e.target.offsetWidth+`px`,t.style.transform=`translateX(${e.target.offsetLeft}px)`})}),e.addEventListener(`mouseleave`,()=>{t.style.opacity=`0`});let n=document.getElementById(`top`),r=document.getElementById(`heroGlow`);if(n&&r){let e;n.addEventListener(`mouseenter`,()=>{e=n.getBoundingClientRect()}),n.addEventListener(`mousemove`,t=>{e||=n.getBoundingClientRect();let i=t.clientX-e.left,a=t.clientY-e.top;r.style.setProperty(`--x`,i+`px`),r.style.setProperty(`--y`,a+`px`)}),window.addEventListener(`resize`,()=>{e=null})}document.querySelectorAll(`.btn:not(.no-magnet)`).forEach(e=>{let t;e.addEventListener(`mouseenter`,()=>{t=e.getBoundingClientRect()}),e.addEventListener(`mousemove`,n=>{t||=e.getBoundingClientRect();let r=n.clientX-t.left-t.width/2,i=n.clientY-t.top-t.height/2;e.style.transform=`translate(${r*.25}px, ${i*.25}px)`}),e.addEventListener(`mouseleave`,()=>{e.style.transform=``,t=null}),window.addEventListener(`resize`,()=>{t=null})});let i=document.querySelector(`.hdr`);window.addEventListener(`scroll`,()=>{window.scrollY>50?i.classList.add(`scrolled`):i.classList.remove(`scrolled`)});let a=document.getElementById(`ls-carousel`),o=document.getElementById(`ls-prev`),s=document.getElementById(`ls-next`);a&&o&&s&&(o.addEventListener(`click`,()=>{a.scrollBy({left:-324,behavior:`smooth`})}),s.addEventListener(`click`,()=>{a.scrollBy({left:324,behavior:`smooth`})}))}